...
const CardM = (props) => {
    return(
      <CardC onClick={() => window.open(props.end)}>
          <Linha>
              <Coluna xl={5}>
                  <CrsM showArrows={false} infiniteLoop={true} autoPlay={true} showThumbs={false} showStatus={false} showIndicators={false}>
                    <ImgExM src={props.img1} alt="" />
                    <ImgExM src={props.img2} alt="" />
                    <ImgExM src={props.img3} alt="" />
                  </CrsM>
              </Coluna>
              <Coluna xl={7}>
